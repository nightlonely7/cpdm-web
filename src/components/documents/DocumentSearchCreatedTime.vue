                ...
                <v-expansion-panel-content :class="`${hover ? 'primary' : ''}`" ripple>
                    ...
                    <template #header>
                        <span :style="`color: ${hover ? 'white' : ''}`">
                            ...
                            Tìm theo thời gian tài liệu hiệu lực
                        </span>
                    </template>
...
<script>
    export default {
        name: "DocumentSearchCreatedTime",
        data() {
            return {
        ...
        methods: {
            reset() {
                ...
                this.$store.commit('DOCUMENT_STORE/SET_CREATED_TIME_FROM_SEARCH_VALUE', null);
                this.$store.commit('DOCUMENT_STORE/SET_CREATED_TIME_TO_SEARCH_VALUE', null);
            },
            clearCreatedDateFrom() {
                this.createdTimeFrom = null;
                this.createdDateFrom = null;
                this.$store.commit('DOCUMENT_STORE/SET_CREATED_TIME_FROM_SEARCH_VALUE', this.createdTimeFromComputed);
            },
            saveCreatedDateFrom() {
            ...
            saveCreatedTimeFrom() {
                ...
                if (this.createdDateFrom === this.createdDateTo) {
                    this.$store.commit('DOCUMENT_STORE/SET_CREATED_TIME_TO_SEARCH_VALUE', this.createdTimeToComputed);
                }
                this.$store.commit('DOCUMENT_STORE/SET_CREATED_TIME_FROM_SEARCH_VALUE', this.createdTimeFromComputed);
            },
            clearCreatedDateTo() {
