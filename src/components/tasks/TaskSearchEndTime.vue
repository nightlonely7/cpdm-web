                ...
                <v-expansion-panel-content :class="`${hover ? 'primary' : ''}`" ripple>
                    ...
                    <template #header>
                        <span :style="`color: ${hover ? 'white' : ''}`">
                            ...
                            Tìm theo thời gian tác vụ kết thúc
                        </span>
                    </template>
    ...
    export default {
        ...
        methods: {
            reset() {
                ...
                this.endTimeTo = null;
                this.$store.commit('TASK_STORE/SET_END_TIME_FROM_SEARCH_VALUE', null);
                this.$store.commit('TASK_STORE/SET_END_TIME_TO_SEARCH_VALUE', null);
            },
            clearEndDateFrom() {
                this.endTimeFrom = null;
                this.endDateFrom = null;
                this.$store.commit('TASK_STORE/SET_END_TIME_FROM_SEARCH_VALUE', this.endTimeFromComputed);
            },
            saveEndDateFrom() {
            ...
            saveEndTimeFrom() {
                ...
                if (this.endDateFrom === this.endDateTo) {
                    this.$store.commit('TASK_STORE/SET_END_TIME_TO_SEARCH_VALUE', this.endTimeToComputed);
                }
                this.$store.commit('TASK_STORE/SET_END_TIME_FROM_SEARCH_VALUE', this.endTimeFromComputed);
            },
            clearEndDateTo() {
